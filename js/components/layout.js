...
const Layout = {
  Header: () => /*html*/`
    <nav class="fixed w-full z-50 transition-all duration-300 bg-white/90 backdrop-blur-xl border-b border-transparent" id="navbar">
      <div class="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20">
        <div class="flex justify-between items-center h-20 md:h-24">
          ...
          <div class="md:hidden flex items-center">
            <button id="mobile-menu-btn" class="text-skynex-dark focus:outline-none p-2">
      ...
      <div id="mobile-menu" class="fixed inset-0 z-40 bg-white transform translate-x-full transition-transform duration-500 ease-in-out md:hidden pt-28 px-6 overflow-y-auto pb-10">
        <div class="flex flex-col space-y-8 text-3xl font-light tracking-tight text-center md:text-left">
          ${UI.MobileNavLinks()}
        </div>
        <div class="mt-16 pt-8 border-t border-skynex-border text-center md:text-left">
          <p class="text-sm font-semibold uppercase tracking-widest text-slate-500 mb-4">Official Contact</p>
  ...
  Footer: () => /*html*/`
    <footer class="bg-white border-t border-skynex-border pt-12 md:pt-16 pb-8">
      <div class="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div class="border-t border-skynex-border mb-8"></div>

        <div class="mb-8">
          <p class="text-xs text-slate-500 leading-relaxed max-w-4xl text-center md:text-left mx-auto md:mx-0">
