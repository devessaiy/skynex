...
const Layout = {
  Header: () => /*html*/`
    <nav class="fixed w-full z-50 transition-all duration-300 bg-white/90 dark:bg-neutral-950/90 backdrop-blur-xl border-b border-transparent" id="navbar">
      ...
      <div id="mobile-menu" class="fixed inset-0 z-40 bg-white dark:bg-neutral-900 transform translate-x-full transition-transform duration-500 ease-in-out md:hidden pt-28 px-6 overflow-y-auto pb-10">
        ...
        <div class="mt-16 pt-8 border-t border-skynex-border dark:border-neutral-800 text-center md:text-left">
          <p class="text-sm font-semibold uppercase tracking-widest text-slate-500 dark:text-slate-400 dark:text-slate-500 mb-4">Official Contact</p>
          <a href="mailto:${AppConfig.company.email}" class="text-lg text-skynex-blue block mb-2">${AppConfig.company.email}</a>
          <p class="text-slate-600">Suleja, Niger State, Nigeria.</p>
        </div>
      </div>
    </nav>
  `,
  ...
  Footer: () => /*html*/`
    <footer class="bg-white dark:bg-neutral-900 border-t border-skynex-border dark:border-neutral-800 pt-12 md:pt-16 pb-8">
      <div class="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div class="mb-8">
          <p class="text-xs text-slate-500 dark:text-slate-400 dark:text-slate-500 leading-relaxed max-w-4xl text-center md:text-left mx-auto md:mx-0">
        ...
        <div class="flex flex-col lg:flex-row justify-center lg:justify-between items-center gap-6">
          <div class="flex flex-wrap items-center justify-center lg:justify-start gap-x-4 gap-y-2">
            ...
            <a href="/privacy-policy" class="text-xs font-medium text-slate-600 hover:text-skynex-dark dark:text-white hover:underline transition-all">Privacy Policy</a>
            <a href="/terms-of-service" class="text-xs font-medium text-slate-600 hover:text-skynex-dark dark:text-white hover:underline transition-all">Terms of Service</a>
            <a href="/legal" class="text-xs font-medium text-slate-600 hover:text-skynex-dark dark:text-white hover:underline transition-all">Legal</a>
            <a href="/sitemap" class="text-xs font-medium text-slate-600 hover:text-skynex-dark dark:text-white hover:underline transition-all">Sitemap</a>
          </div>
          <div class="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6">
            <span class="text-xs font-bold text-slate-500 dark:text-slate-400 dark:text-slate-500 tracking-widest uppercase">Stay Connected</span>
            <div class="flex gap-4 justify-center">
              <a href="https://www.linkedin.com/company/skynex-solutions-limited/" class="text-slate-800 hover:text-skynex-blue transition-colors"><i class="fa-brands fa-linkedin-in text-lg"></i></a>
              <a href="https://x.com/official_skynex" class="text-slate-800 hover:text-skynex-dark dark:text-white transition-colors"><i class="fa-brands fa-x-twitter text-lg"></i></a>
              <a href="#" class="text-slate-800 hover:text-skynex-dark dark:text-white transition-colors"><i class="fa-brands fa-instagram text-lg"></i></a>
            </div>
          </div>
        </div>
      </div>
