            ...
            <div>
              ...
              <form class="space-y-8" onsubmit="event.preventDefault();">
                <div>
                  ...
                  <input type="text" class="w-full bg-transparent border-b border-slate-300 py-3 text-skynex-dark focus:outline-none focus:border-skynex-dark transition-colors" placeholder="Jane Doe">
                </div>
                <div>
                  <label class="block text-xs font-bold tracking-widest uppercase text-slate-500 mb-2">Email Address</label>
                  <input type="email" class="w-full bg-transparent border-b border-slate-300 py-3 text-skynex-dark focus:outline-none focus:border-skynex-dark transition-colors" placeholder="jane@company.com">
                </div>
                <div>
                  <label class="block text-xs font-bold tracking-widest uppercase text-slate-500 mb-2">Message or Requirement</label>
                  <textarea rows="4" class="w-full bg-transparent border-b border-slate-300 py-3 text-skynex-dark focus:outline-none focus:border-skynex-dark transition-colors resize-none" placeholder="How can we assist your business?"></textarea>
                </div>
                <button type="submit" class="px-10 py-4 bg-skynex-dark text-white text-sm font-bold tracking-widest uppercase rounded-full hover:bg-slate-800 transition-colors">
                  Submit Message
                </button>
              </form>
            </div>
